...
>
    ...
    methods: {
        ...
        handleEdit(data) {
            console.debug('csharp editIntegration', data)
                ...
                response.json().then(
                    errorData => {
                        errorData.forEach(item => {
                            console.debug('csharp item error', item)
...
register_component('CsharpIntegration', CsharpIntegration)
